...
(function(){
	var saveFormUrl = 'sys/user/save-form.action';
    ...
    simple.on("render",function(cmp){
    	var config = {
    		url:'sys/user/edit-form-data.action', 
    ...
    /*var win = new Ext.Window({
        ...
        buttons: [{
            text: '保存',
            handler:function(){
            	simple.getForm().submit(commonSubmitConfig);
            }
        },{
            text: '取消',
            handler:function(){
            	var tabs = Ext.getCmp("tabs");
				var tab = tabs.getItem("editUserFormTab${editId}");
				tabs.remove(tab);
            }
        }]
    });*/

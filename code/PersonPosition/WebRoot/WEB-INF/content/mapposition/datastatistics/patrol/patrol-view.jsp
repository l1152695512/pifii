...
(function(){
	var pageLimit = 20;
	var patrol_storeFields = ['date','person_name','route_name','start_time','end_time','position_date','is_done','phone','route_time_id'];
	var patrol_store = new Ext.data.JsonStore({
        ...
        url: 'mapposition/datastatistics/patrol/patrol-data.action'
    });
    ...
    var rowAction=	new Ext.ux.grid.RowActions({
		 ...
		 actions:[{
			...
			callback:function(grid, record, action, row, col){
				...
				Ext.Ajax.request({
					url:'mapposition/datastatistics/patrol/patrol-info-view.action',
					params:{personName:record.data.person_name,routeName:record.data.route_name,
								date:record.data.date,phone:record.data.phone,routeTimeId:record.data.route_time_id},
	...
	var route_store = new Ext.data.JsonStore({ 
		url:'mapposition/datastatistics/patrol/get-routes.action',
		fields : ['id','name'], 
		root : "values"
	});

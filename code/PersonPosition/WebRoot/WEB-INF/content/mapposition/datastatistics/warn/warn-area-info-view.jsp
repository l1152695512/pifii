...
(function(){
	...
	var warn_area_info_store = new Ext.data.JsonStore({
        root: 'list',
        autoLoad:{params:{phone:'${phone}',areaId:'${areaId}',areaTimeId:'${areaTimeId}',date:'${date}',areaType:'${areaType}'}},
        totalProperty: 'totalRecord',
        idProperty: 'id',
        remoteSort: false,
        fields: warn_area_info_storeFields,
        url: 'mapposition/datastatistics/warn/warn-area-info-data.action'
    });
...
//        })
	...
	var warn_area_info_win = new Ext.Window({
		title: '${date}&nbsp;&nbsp;>&nbsp;&nbsp;${personName}&nbsp;&nbsp;>&nbsp;&nbsp;${areaName}',
		layout : 'fit',
		width : 500,
		height : 300,
        border:false,

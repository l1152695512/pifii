/*!
 * jQuery ClassySlider
 * http://www.class.pm/projects/jquery/classyslider
 *
...
(function (b) {
    ...
    d.fn = d.prototype = {
        ...
        create: function (a, c) {
            ...
            b(a).addClass("classyslider-vertical-slider");
    ...
    b.fn.ClassySlider = function (a) {
        return this.each(function () {
            var c = b(this);
            if (c.data("classyslider")) {
                return c.data("classyslider");
            }
            var e = new d(this, a);
            c.data("classyslider", e)
        })
    };

...
public class UploadAction extends ActionSupport implements ServletRequestAware,ServletContextAware{
	...
	public String execute() throws Exception {
        ...
        try {
            ...
            if(itemList != null){
            	...
            	while(it.hasNext()){
            		...
            		if(chkImgName(item.getName())){
	            		if(!item.isFormField()){
	            			  String uploadPath = this.context.getRealPath("/temp/"+request.getSession().getId());
	                          ...
	                          randomFileName = RandomStringUtils.random(18,true,true)+"."+suffix;
			...
			logger.error(msg, e);
			return "failure";
	    	//request.setAttribute("uploadMsg", "请求类型enctype != multipart/form-data");
		    //req.getRequestDispatcher("/uploadError.jsp").forward(req, resp);

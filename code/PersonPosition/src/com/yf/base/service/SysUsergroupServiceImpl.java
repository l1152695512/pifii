 ...
 * 
 * @version 1.0
 * 对应com.yf.base.db.vo.SysUsergroup
...
public class SysUsergroupServiceImpl implements SysUsergroupService {;
	...
	public List getAll() {
		return this.daoHandler.getSysUsergroupDAO().findWithCriteria(DetachedCriteria.forClass(SysUsergroup.class));
	}

	public List getAllWithOrderBy(SortBy o) {
		return this.daoHandler.getSysUsergroupDAO().findWithCriteria(BasicDAO.addOrderToDetachedCriteria(o,DetachedCriteria.forClass(SysUsergroup.class)));
	}
	...
	public PageList getByPage(int pageSize,int currentPage) {
		return this.daoHandler.getSysUsergroupDAO().findWithCriteriaByPage(DetachedCriteria.forClass(SysUsergroup.class),currentPage,pageSize);
	}

	public PageList getByPageWithOrderBy(int pageSize,int currentPage,SortBy o) {
		return this.daoHandler.getSysUsergroupDAO().findWithCriteriaByPage(BasicDAO.addOrderToDetachedCriteria(o,DetachedCriteria.forClass(SysUsergroup.class)),currentPage,pageSize);
	}
	...
	public PageList findByExampleByPage(SysUsergroup vo,String pageSize,String currentPage) {
		int pageSizeInt=Integer.parseInt(pageSize);
		int currentPageInt=Integer.parseInt(currentPage);
		return this.findByExampleByPage(vo,pageSizeInt,currentPageInt);
	}

	public PageList findByExampleByPageWithOrderBy(SysUsergroup vo,String pageSize,String currentPage,SortBy o) {
		int pageSizeInt=Integer.parseInt(pageSize);
		int currentPageInt=Integer.parseInt(currentPage);
		return this.findByExampleByPageWithOrderBy(vo,pageSizeInt,currentPageInt,o);
	}

	public PageList findByExampleByPage(SysUsergroup vo,int pageSize,int currentPage) {
		return this.daoHandler.getSysUsergroupDAO().findExactLikeByPage(vo,currentPage,pageSize);
	}

	public PageList findByExampleByPageWithOrderBy(SysUsergroup vo,int pageSize,int currentPage,SortBy o) {
		return this.daoHandler.getSysUsergroupDAO().findExactLikeByPageWithOrderBy(vo,currentPage,pageSize,o);
	}

	public PageList findByExampleByDefaultPage(SysUsergroup vo,String currentPage) {
		return this.findByExampleByPage(vo,com.yf.data.create.SystemConstants.DEFAULT_PAGE_SIZE,Integer.parseInt(currentPage));
	}

	public PageList findByExampleByDefaultPageWithOrderBy(SysUsergroup vo,String currentPage,SortBy o) {
	...
	public PageList findByExampleByDefaultPage(SysUsergroup vo,int currentPage) {
		return this.findByExampleByPage(vo,com.yf.data.create.SystemConstants.DEFAULT_PAGE_SIZE,currentPage);
	}

	public PageList findByExampleByDefaultPageWithOrderBy(SysUsergroup vo,int currentPage,SortBy o) {
		return this.findByExampleByPageWithOrderBy(vo,com.yf.data.create.SystemConstants.DEFAULT_PAGE_SIZE,currentPage,o);
	}

	public List findByExample(SysUsergroup vo) {
		return this.daoHandler.getSysUsergroupDAO().findExactLike(vo);
	}

	public List findByExampleWithOrderBy(SysUsergroup vo,SortBy o) {
		return this.daoHandler.getSysUsergroupDAO().findExactLikeWithOrderBy(vo,o);
	}

	public SysUsergroup findById(java.lang.String id) {
		return this.daoHandler.getSysUsergroupDAO().findById(id);
	}
	...
	public List findByIds(java.lang.String[] ids) {
		...
		for(int i = 0 ; i < ids.length ; i++){
			SysUsergroup vo = this.daoHandler.getSysUsergroupDAO().findById(ids[i]);
	...
	public List findByProperty(String propName,Object value) {
		return this.daoHandler.getSysUsergroupDAO().findByProperty(propName,value);
	}

	public List findByPropertyWithOrderBy(String propName,Object value,SortBy o) {
		return this.daoHandler.getSysUsergroupDAO().findByPropertyWithOrderBy(SysUsergroup.class, propName, value, o);
	}

	public PageList findByPropertyByPage(String propName,Object value,int pageSize,int currentPage) {
		return this.daoHandler.getSysUsergroupDAO().findByPropertyByPage(SysUsergroup.class,propName,value,currentPage,pageSize);
	}
	...
	public PageList findByPropertyByPageWithOrderBy(String propName,Object value,int pageSize,int currentPage,SortBy o) {
		return this.daoHandler.getSysUsergroupDAO().findByPropertyByPageWithOrderBy(SysUsergroup.class,propName,value,currentPage,pageSize,o);
	}
	...
	public PageList findByPropertyByDefaultPageWithOrderBy(String propName,Object value,int currentPage,SortBy o) {
		return this.daoHandler.getSysUsergroupDAO().findByPropertyByPageWithOrderBy(SysUsergroup.class, propName, value, currentPage, com.yf.data.create.SystemConstants.DEFAULT_PAGE_SIZE, o);
	}
	...
	public List findByDetachedCriteria(DetachedCriteria dc) {
		return this.daoHandler.getSysUsergroupDAO().findWithCriteria(dc);
	}

	public PageList findByDetachedCriteriaByPage(DetachedCriteria dc,int pageSize,int currentPage) {
		return this.daoHandler.getSysUsergroupDAO().findWithCriteriaByPage(dc,currentPage,pageSize);
	}
	...
	public void update(SysUsergroup vo) {
		this.daoHandler.getSysUsergroupDAO().update(vo);
	}

	public void saveOrUpdate(SysUsergroup vo) {
		this.daoHandler.getSysUsergroupDAO().saveOrUpdate(vo);
	}

	public void add(SysUsergroup vo) {
		this.daoHandler.getSysUsergroupDAO().save(vo);
	}

	public void delete(SysUsergroup vo) {
		this.daoHandler.getSysUsergroupDAO().delete(vo);
	}

	public void deleteById(Serializable id) {
		this.daoHandler.getSysUsergroupDAO().delete(SysUsergroup.class, id);
	}

	public void deleteByIdList(List ids) {
		this.daoHandler.getSysUsergroupDAO().deleteListByPk(SysUsergroup.class, ids);
	}
	...
	public void deleteList(List voList) {
		this.daoHandler.getSysUsergroupDAO().deleteList(voList);
	}

	public boolean validate(SysUsergroup vo) {
		return true;
	}

	public DetachedCriteria createCriteria() {
		return DetachedCriteria.forClass(SysUsergroup.class);
	}
	...
	public  int getRowCountByDc(DetachedCriteria dc){
		return this.daoHandler.getSysUsergroupDAO().getRowCount(dc);
	}
}

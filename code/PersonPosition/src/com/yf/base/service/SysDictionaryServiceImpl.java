 ...
 * 
 * @version 1.0
 * 对应com.yf.base.db.vo.SysDictionary
...
public class SysDictionaryServiceImpl implements SysDictionaryService {;
	...
	public List getAll() {
		return this.daoHandler.getSysDictionaryDAO().findWithCriteria(DetachedCriteria.forClass(SysDictionary.class));
	}

	public List getAllWithOrderBy(SortBy o) {
		return this.daoHandler.getSysDictionaryDAO().findWithCriteria(BasicDAO.addOrderToDetachedCriteria(o,DetachedCriteria.forClass(SysDictionary.class)));
	}
	...
	public PageList getByPage(int pageSize,int currentPage) {
		return this.daoHandler.getSysDictionaryDAO().findWithCriteriaByPage(DetachedCriteria.forClass(SysDictionary.class),currentPage,pageSize);
	}

	public PageList getByPageWithOrderBy(int pageSize,int currentPage,SortBy o) {
		return this.daoHandler.getSysDictionaryDAO().findWithCriteriaByPage(BasicDAO.addOrderToDetachedCriteria(o,DetachedCriteria.forClass(SysDictionary.class)),currentPage,pageSize);
	}
	...
	public PageList findByExampleByPage(SysDictionary vo,String pageSize,String currentPage) {
		int pageSizeInt=Integer.parseInt(pageSize);
		int currentPageInt=Integer.parseInt(currentPage);
		return this.findByExampleByPage(vo,pageSizeInt,currentPageInt);
	}

	public PageList findByExampleByPageWithOrderBy(SysDictionary vo,String pageSize,String currentPage,SortBy o) {
		int pageSizeInt=Integer.parseInt(pageSize);
		int currentPageInt=Integer.parseInt(currentPage);
		return this.findByExampleByPageWithOrderBy(vo,pageSizeInt,currentPageInt,o);
	}

	public PageList findByExampleByPage(SysDictionary vo,int pageSize,int currentPage) {
		return this.daoHandler.getSysDictionaryDAO().findExactLikeByPage(vo,currentPage,pageSize);
	}

	public PageList findByExampleByPageWithOrderBy(SysDictionary vo,int pageSize,int currentPage,SortBy o) {
		return this.daoHandler.getSysDictionaryDAO().findExactLikeByPageWithOrderBy(vo,currentPage,pageSize,o);
	}

	public PageList findByExampleByDefaultPage(SysDictionary vo,String currentPage) {
		return this.findByExampleByPage(vo,com.yf.data.create.SystemConstants.DEFAULT_PAGE_SIZE,Integer.parseInt(currentPage));
	}

	public PageList findByExampleByDefaultPageWithOrderBy(SysDictionary vo,String currentPage,SortBy o) {
	...
	public PageList findByExampleByDefaultPage(SysDictionary vo,int currentPage) {
		return this.findByExampleByPage(vo,com.yf.data.create.SystemConstants.DEFAULT_PAGE_SIZE,currentPage);
	}

	public PageList findByExampleByDefaultPageWithOrderBy(SysDictionary vo,int currentPage,SortBy o) {
		return this.findByExampleByPageWithOrderBy(vo,com.yf.data.create.SystemConstants.DEFAULT_PAGE_SIZE,currentPage,o);
	}

	public List findByExample(SysDictionary vo) {
		return this.daoHandler.getSysDictionaryDAO().findExactLike(vo);
	}

	public List findByExampleWithOrderBy(SysDictionary vo,SortBy o) {
		return this.daoHandler.getSysDictionaryDAO().findExactLikeWithOrderBy(vo,o);
	}

	public SysDictionary findById(java.lang.String id) {
		return this.daoHandler.getSysDictionaryDAO().findById(id);
	}
	...
	public List findByIds(java.lang.String[] ids) {
		...
		for(int i = 0 ; i < ids.length ; i++){
			SysDictionary vo = this.daoHandler.getSysDictionaryDAO().findById(ids[i]);
	...
	public List findByProperty(String propName,Object value) {
		return this.daoHandler.getSysDictionaryDAO().findByProperty(propName,value);
	}

	public List findByPropertyWithOrderBy(String propName,Object value,SortBy o) {
		return this.daoHandler.getSysDictionaryDAO().findByPropertyWithOrderBy(SysDictionary.class, propName, value, o);
	}

	public PageList findByPropertyByPage(String propName,Object value,int pageSize,int currentPage) {
		return this.daoHandler.getSysDictionaryDAO().findByPropertyByPage(SysDictionary.class,propName,value,currentPage,pageSize);
	}
	...
	public PageList findByPropertyByPageWithOrderBy(String propName,Object value,int pageSize,int currentPage,SortBy o) {
		return this.daoHandler.getSysDictionaryDAO().findByPropertyByPageWithOrderBy(SysDictionary.class,propName,value,currentPage,pageSize,o);
	}
	...
	public PageList findByPropertyByDefaultPageWithOrderBy(String propName,Object value,int currentPage,SortBy o) {
		return this.daoHandler.getSysDictionaryDAO().findByPropertyByPageWithOrderBy(SysDictionary.class, propName, value, currentPage, com.yf.data.create.SystemConstants.DEFAULT_PAGE_SIZE, o);
	}
	...
	public List findByDetachedCriteria(DetachedCriteria dc) {
		return this.daoHandler.getSysDictionaryDAO().findWithCriteria(dc);
	}

	public PageList findByDetachedCriteriaByPage(DetachedCriteria dc,int pageSize,int currentPage) {
		return this.daoHandler.getSysDictionaryDAO().findWithCriteriaByPage(dc,currentPage,pageSize);
	}
	...
	public void update(SysDictionary vo) {
		this.daoHandler.getSysDictionaryDAO().update(vo);
	}

	public void saveOrUpdate(SysDictionary vo) {
		this.daoHandler.getSysDictionaryDAO().saveOrUpdate(vo);
	}

	public void add(SysDictionary vo) {
		this.daoHandler.getSysDictionaryDAO().save(vo);
	}

	public void delete(SysDictionary vo) {
		this.daoHandler.getSysDictionaryDAO().delete(vo);
	}

	public void deleteById(Serializable id) {
		this.daoHandler.getSysDictionaryDAO().delete(SysDictionary.class, id);
	}

	public void deleteByIdList(List ids) {
		this.daoHandler.getSysDictionaryDAO().deleteListByPk(SysDictionary.class, ids);
	}
	...
	public void deleteList(List voList) {
		this.daoHandler.getSysDictionaryDAO().deleteList(voList);
	}

	public boolean validate(SysDictionary vo) {
		return true;
	}

	public DetachedCriteria createCriteria() {
		return DetachedCriteria.forClass(SysDictionary.class);
	}
	...
	public  int getRowCountByDc(DetachedCriteria dc){
		return this.daoHandler.getSysDictionaryDAO().getRowCount(dc);
	}
}

...
public class SaveRoutePointTime extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		if(StringUtils.isNotBlank(id)){
			sql.append("update bp_coarse_route_point_time_tbl set start_time=?,end_time=?,update_time=now() where id=? ");
			...
			sql.append("insert into bp_coarse_route_point_time_tbl(id,route_point_id,route_time_id,start_time,end_time,update_time) ");

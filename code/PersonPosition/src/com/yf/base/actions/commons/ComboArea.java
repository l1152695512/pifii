...
public class ComboArea extends BaseAction  {
...
//		}
		...
		dc.add(Restrictions.eq("ywRegion.rid", this.pid));
		List<YwRegion> regionList = this.ywRegionService.findByDetachedCriteria(dc);
		
		for(YwRegion region: regionList)
		{
			o = new JSONObject();
			o.put("name", region.getName());
			o.put("areaId", region.getRid());
			arry.add(o);
		}

...
public class ComboDept extends BaseAction  {
	...
	public void executeDoing(){
	    ...
	    List clist = this.ywCompanyService.findByDetachedCriteria(dc);
	    
	    if(!clist.isEmpty())
	    {
	    	for(int i = 0; i < clist.size(); i++)
	    	{
	    		YwCompany yc = (YwCompany)clist.get(i);
	    		o=new JSONObject();
	    		o.put("name" ,yc.getCname());
	    		o.put("dno", yc.getDeptNo());
	    		arry.add(o);
	    	}
	    }
...
//		if(usergroupString.contains(("省公司用户组"))||usergroupString.contains(("因孚网络科技有限公司用户组"))||usergroupString.contains(("管理员用户组"))||usergroupString.contains(("研究院用户组"))){
...
//	    		o.put("rid", ywRegion.getRid());
//	    		arry.add(o);
//				List <YwRegion >sunList=ywRegion.getYwRegions();
//				for (YwRegion sun : sunList) {
//					o=new JSONObject();
//		    		o.put("name" ,sun.getName());
//		    		o.put("rid", sun.getRid());
//		    		arry.add(o);
//				}
//	    		
//			}

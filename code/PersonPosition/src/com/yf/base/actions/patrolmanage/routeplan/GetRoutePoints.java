...
public class GetRoutePoints extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		sql.append("select id,name,previous_point_id,next_point_id,location_x,location_y,effective_range,");
		sql.append("effective_start_time,effective_end_time,DATE_FORMAT(add_date,'%Y-%m-%d %H:%i:%s') add_date ");
		sql.append("from bp_fine_route_point_tbl ");

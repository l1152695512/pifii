...
public class AssignedPerson_1 extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		strB.append("from bp_warn_area_person_assign_tbl a join bp_person_tbl p on (a.person_id = p.id) ");
		strB.append("where a.warn_area_id = '");
		strB.append(nodeId);
		strB.append("' ");

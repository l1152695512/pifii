...
public class NewMenu extends ActionSupport implements ServletRequestAware {
	...
	private void processTreeNode(JSONArray array , List menus ,List authMenus){
		...
		for (Iterator iterator = menus.iterator(); iterator.hasNext();) {
			...
			if(bean.getEnabled()!=null && !bean.getEnabled() && authMenus.contains(bean) && bean.getSysMenu() == null){

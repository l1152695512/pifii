...
public class SysUsergroupMenusDAO extends HibernateDaoSupport {
	...
	public void save(SysUsergroupMenus transientInstance) {
		log.debug("saving SysUsergroupMenus instance");
		try {
	...
	public void delete(SysUsergroupMenus persistentInstance) {
		log.debug("deleting SysUsergroupMenus instance");
		try {
	...
	public SysUsergroupMenus findById(java.lang.String id) {
		log.debug("getting SysUsergroupMenus instance with id: " + id);
		try {
	...
	public List findByExample(SysUsergroupMenus instance) {
		log.debug("finding SysUsergroupMenus instance by example");
		try {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding SysUsergroupMenus instance with property: "
	...
	public List findAll() {
		log.debug("finding all SysUsergroupMenus instances");
		try {
	...
	public SysUsergroupMenus merge(SysUsergroupMenus detachedInstance) {
		log.debug("merging SysUsergroupMenus instance");
		try {
	...
	public void attachDirty(SysUsergroupMenus instance) {
		log.debug("attaching dirty SysUsergroupMenus instance");
		try {
	...
	public void attachClean(SysUsergroupMenus instance) {
		log.debug("attaching clean SysUsergroupMenus instance");
		try {

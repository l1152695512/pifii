...
public class YwRegionDAO extends HibernateDaoSupport {
	...
	public void save(YwRegion transientInstance) {
		log.debug("saving YwRegion instance");
		try {
	...
	public void delete(YwRegion persistentInstance) {
		log.debug("deleting YwRegion instance");
		try {
	...
	public YwRegion findById(java.lang.String id) {
		log.debug("getting YwRegion instance with id: " + id);
		try {
	...
	public List findByExample(YwRegion instance) {
		log.debug("finding YwRegion instance by example");
		try {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding YwRegion instance with property: " + propertyName
				+ ", value: " + value);
		try {
	...
	public List findAll() {
		log.debug("finding all YwRegion instances");
		try {
	...
	public YwRegion merge(YwRegion detachedInstance) {
		log.debug("merging YwRegion instance");
		try {
	...
	public void attachDirty(YwRegion instance) {
		log.debug("attaching dirty YwRegion instance");
		try {
	...
	public void attachClean(YwRegion instance) {
		log.debug("attaching clean YwRegion instance");
		try {

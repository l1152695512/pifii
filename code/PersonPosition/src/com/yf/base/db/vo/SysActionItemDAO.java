...
public class SysActionItemDAO extends HibernateDaoSupport  {
    ...
    public void save(SysActionItem transientInstance) {
        log.debug("saving SysActionItem instance");
        try {
	...
	public void delete(SysActionItem persistentInstance) {
        log.debug("deleting SysActionItem instance");
        try {
    ...
    public SysActionItem findById( java.lang.String id) {
        log.debug("getting SysActionItem instance with id: " + id);
        try {
    ...
    public List findByExample(SysActionItem instance) {
        log.debug("finding SysActionItem instance by example");
        try {
    ...
    public List findByProperty(String propertyName, Object value) {
      log.debug("finding SysActionItem instance with property: " + propertyName
            + ", value: " + value);
      try {
	...
	public List findAll() {
		log.debug("finding all SysActionItem instances");
		try {
    ...
    public SysActionItem merge(SysActionItem detachedInstance) {
        log.debug("merging SysActionItem instance");
        try {
    ...
    public void attachDirty(SysActionItem instance) {
        log.debug("attaching dirty SysActionItem instance");
        try {
    ...
    public void attachClean(SysActionItem instance) {
        log.debug("attaching clean SysActionItem instance");
        try {

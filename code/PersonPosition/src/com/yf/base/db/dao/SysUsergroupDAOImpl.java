...
public class SysUsergroupDAOImpl extends BasicDAO implements SysUsergroupDAO {
	...
	public void save(SysUsergroup transientInstance) {
		if(log.isDebugEnabled())log.debug("saving SysUsergroup instance");
		try {
	...
	public void delete(SysUsergroup persistentInstance) {
		if(log.isDebugEnabled())log.debug("deleting SysUsergroup instance");
		try {
	...
	public SysUsergroup findById(java.lang.String id) {
		if(log.isDebugEnabled())log.debug("getting SysUsergroup instance with id: " + id);
		try {
	...
	public List findByExample(SysUsergroup instance) {
		if(log.isDebugEnabled())log.debug("finding SysUsergroup instance by example");
		try {
	...
	public List findByProperty(String propertyName, Object value) {
		if(log.isDebugEnabled())log.debug("finding SysUsergroup instance with property: "
	...
	public List findAll() {
		if(log.isDebugEnabled())log.debug("finding all SysUsergroup instances");
		try {
	...
	public SysUsergroup merge(SysUsergroup detachedInstance) {
		if(log.isDebugEnabled())log.debug("merging SysUsergroup instance");
		try {
	...
	public void attachDirty(SysUsergroup instance) {
		if(log.isDebugEnabled())log.debug("attaching dirty SysUsergroup instance");
		try {
	...
	public void attachClean(SysUsergroup instance) {
		if(log.isDebugEnabled())log.debug("attaching clean SysUsergroup instance");
		try {

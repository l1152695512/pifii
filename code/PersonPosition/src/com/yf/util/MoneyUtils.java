...
public class MoneyUtils {
	...
	public static void main(String[] ar) {
		// Debug.println(new MoneyFormat().format("10005022.123009"));
		Debug.println(MoneyUtils.toChinese("11.2311"));
		Debug.println(MoneyUtils.toChinese("10.01"));
		Debug.println(MoneyUtils.toChinese("0"));
		Debug.println(MoneyUtils.toChinese(""));
		Debug.println(MoneyUtils.toChinese(null));
	}

...
public class Food {
	...
	public JSONObject getOrder(String historyOrderId){
...
//		}
	...
	public JSONObject saveFoodOrder(String historyOrderId,String[] foods){//如果已下了订单就直接返回订单，并刷新页面，显示订单页
		JSONObject json = new JSONObject();

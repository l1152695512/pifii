...
//					'X', 'Y', 'Z'};
			...
			public void init() throws ServletException {
				...
				String strMaxRandomPositionX =this.getInitParameter("maxRandomPositionX");
				...
				try {
					...
					if (strMaxRandomPositionX != null && strMaxRandomPositionX.length() != 0) {
			...
			protected void service(HttpServletRequest req, HttpServletResponse resp)
				...
				for (int i = 0; i < codeCount; i++) {
					...
					colorList.add(color);
					g.setColor(color);
					g.drawString(strRand, leftMargin+(i * x)+(int)((Math.random()-0.5)*this.maxRandomPositionX), codeY);

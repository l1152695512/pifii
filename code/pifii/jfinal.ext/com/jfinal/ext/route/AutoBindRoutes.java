...
public class AutoBindRoutes extends Routes {
    ...
    public void config() {
        ...
        L.i(" serach  controller class ="+controllerClasses);
...
//    private String getPacknameKey(Class clazz){
//    	
//    	String packname="";
//    	try{
//    	  packname ="/"+clazz.getPackage().getName().split(".")[ clazz.getPackage().getName().split(".").length-2].toLowerCase();
//    	}
//    	catch(Exception e){
//    	}
//    	 return packname;

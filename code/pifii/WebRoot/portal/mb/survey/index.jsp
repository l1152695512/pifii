...
<!-- 		    </div> -->
		...
		<script type="text/javascript">
			...
			if(questionsHtml == ''){
				questionsHtml = '<div style="color:red;text-align:center;margin-top:20px;margin-bottom:20px;"><h2>暂无调查问卷问题</h2></div>';
				$("#box1 .sub").hide();
			}
			...
			function submit(){
				$.ajax({
					type : "POST",
					url : '${pageContext.request.contextPath}/portal/mb/survey/save',
					async:true,

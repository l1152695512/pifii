...
<html>
	<head>
		...
		<style type="text/css">
			...
			.bofang{position: absolute;left: 40%;bottom: 50%;background: url(${pageContext.request.contextPath}/portal/mb/video/img/bofang.png) no-repeat 50% 50%;width:40px;height:40px;}
			/* 本例子css -------------------------------------- */
		</style>
	</head>
	<body>
		<div id="content">
			...
			<ul class="tro">
			<c:forEach items="${videos}" var="row">
				<li>
   					<a href="${row.link}" class="pic">
						<img src="${row.icon}"/>

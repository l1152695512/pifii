...
<html>
	<head>
		...
		<style type="text/css">
			...
			.bofang{position: absolute;z-index: 2;left: 40%;bottom: 41%;background: url(${pageContext.request.contextPath}/portal/mb/audio/img/bofang.png) no-repeat 50% 50%;width:40px;height:40px;}
			/* 本例子css -------------------------------------- */
		</style>
	</head>
	<body>

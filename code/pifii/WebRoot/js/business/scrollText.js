...
var stopTimeLength = 1500;
var scrollingTextIntervalTime = 70;
...
function scrollingText(){
	for(var i=0;i<scrollElementList.length;i++){
		...
		var left = (parseFloat(thisElement.css("left"))-scrollingTextMoveSize)%(thisElement.width()+5-scrollElementList[i].showWidth);

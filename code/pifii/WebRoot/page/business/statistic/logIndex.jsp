...
<!-- 			<li style="width: 150px;">wifi</li> -->
			...
			<li style="width: 450px;">访问地址</li>
			<li style="width: 150px;">访问时间</li>
		</ul>
		<div class="cl"></div>
...
<script type="text/javascript">
	...
	function generPageCertifiedPager(){
		...
		$("#certifiedList .holder").jPages({
			...
			realPagination:true,
	        serverParams:{
	        	url:"business/statistics/getLogInfo",
	        	data:data,
...
// 								'<li style="width: '+list_header.eq(1).width()+'px;">'+data[i].name+'</li>'+
								'<li style="width: '+list_header.eq(1).width()+'px;">'+data[i].tag+'</li>'+
								'<li style="width: '+list_header.eq(2).width()+'px;">'+data[i].input_mac+'</li>'+
								'<li style="width: '+list_header.eq(3).width()+'px;">'+data[i].link+'</li>'+
								'<li style="width: '+list_header.eq(4).width()+'px;">'+data[i].create_date+'</li>'+
